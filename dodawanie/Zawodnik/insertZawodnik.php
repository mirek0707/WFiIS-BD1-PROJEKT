...
<?php
    ...
    $query = "INSERT INTO projekt.Zawodnik (ID_zawodnik, ID_klub, ID_kraj, Imie, Nazwisko, Data_urodzenia, Wzrost, Waga, Pozycja, Numer) 
            VALUES ( nextval('zawodnik_id_seq'),'$klub_id', '$kraj_id', '$imie', '$nazwisko', '$data_ur', '$wzrost', '$waga', '$poz', '$num')";
