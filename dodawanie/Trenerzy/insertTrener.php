...
<?php
    ...
    $query = "INSERT INTO projekt.Trener (ID_trener, ID_klub, ID_kraj, Imie, Nazwisko, Data_urodzenia, Licencja_trenerska) 
            VALUES ( nextval('trener_id_seq'),'$klub_id', '$kraj_id', '$imie', '$nazwisko', '$data_ur', '$lic')";
