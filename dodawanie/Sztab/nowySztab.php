...
<head>
    ...
    <title>Dodaj nowego członka sztabu</title>
</head>
<body>
    <header class="header" id="myHeader">
        <div class="tytul">
            ...
            <b class="lb">DODAWANIE NOWEGO CZŁONKA SZTABU</b>
        </div>
    ...
    <div class="formularz">
        ...
        <form class="center" action="insertSztab.php" method="POST">
        ...
        <h3 class="center">Podaj stanowisko/rolę:</h3>
        <input type="text" name = "rola" placeholder="Wpisz stanowisko" value = "" required><br><br>

        <input type="submit" value = "Zapisz członka sztabu">
