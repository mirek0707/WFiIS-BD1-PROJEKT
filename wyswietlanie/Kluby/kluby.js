...
function pokazKluby() {
    ...
    KlubyRequest(kraj, liga);
}

function KlubyRequest(kraj, liga) {
    xmlHttp = getRequestObject();
    if (xmlHttp) {
        try {
            var url = "./klubyFiltr.php?kraj=" + kraj + "&liga=" + liga;
            xmlHttp.onreadystatechange = handleResponseKluby;
